...
const PlayerScreen: React.FC<PlayerScreenProps> = ({ route, navigation }) => {
  ...
  const { requestMicrophonePermission, startVoiceRecognition } = useVoiceRecognition(
    {recognizedTextRef,
    speechTimeoutRef,
