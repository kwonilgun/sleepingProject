...
import {
  MembershipUsageTermScreenProps,
  UsageTermScreenProps,
} from '../../Screens/model/types/TUserNavigator';
...
const MembershipUsageTermScreen: React.FC<
  MembershipUsageTermScreenProps
> = props => {
  ...
  const onPressLeft = () => {
    console.log('MembershipUsageTermScreen.tsx: onPressLeft');
...
async function getUsageTermsFromS3(
  ...
  console.log('MembershipUsageTermScreen: language = ', language);
...
const styles = StyleSheet.create({
  scrollView: {
    ...
    // backgroundColor: '#606060' /* 배경 색상 */,
  },
});

export default MembershipUsageTermScreen;
